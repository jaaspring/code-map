  ...
  Future<void> _submitAllAnswers() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        if (user != null) {
          // 1. Mark assessment as completed (handles counters and weekly logic safely)
          ...
          // 2. Refresh user data to get updated counts for badge checking
          ...
          final newBadges = await BadgeService.checkAndAwardBadge(
            ...
            contextData: {
              ...
              'weeklyAssessments': userData['weeklyAssessments'] ?? 0,
            }
          );

          // 4. Show dialog if earned
